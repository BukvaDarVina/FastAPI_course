...
def upgrade() -> None:
    ...
    op.add_column("users", sa.Column("first_name", sa.String(length=150), nullable=False))
    op.add_column("users", sa.Column("last_name", sa.String(length=150), nullable=False))
